# 🚀 Demomusti - Generated Microservice Platform
...
- [ ] Open a terminal and run:
  ```bash
  git clone https://github.com/QuickCodeNet/demomusti.git
  ```
...
- [ ] In a new terminal, run all tests:
  ```bash
  dotnet test QuickCode.Demomusti.Docker.sln
  ```
...
**Demomusti** is a modular, enterprise-grade .NET solution generated by [quickcode.net](https://quickcode.net).  
...
demomusti/
  src/
    ...
    Modules/
      ...
      IdentityModule/
    Presentation/
      QuickCode.Demomusti.Gateway/
      QuickCode.Demomusti.Portal/
    Services/
    ...
  docker-compose.yml
  README.md
...
- Architecture Diagram:
  ![Architecture Diagram](https://www.quickcode.net/diagram/demomusti)
...
- **Gateway Dashboard:**
    ...
    - Your project: e.g. [https://demomusti-gateway.quickcode.net](https://demomusti-gateway.quickcode.net)
...
- **Portal Dashboard:**
    ...
    - Demo user credentials:
        - Username : demo@quickcode.net
        - Password : String1!
    - Your project: e.g. [https://demomusti-portal.quickcode.net](https://demomusti-portal.quickcode.net)
...
- **Gateway:**
    - link: [https://demomusti-gateway.quickcode.net](https://demomusti-gateway.quickcode.net)
- **Portal:**
    - link: [https://demomusti-portal.quickcode.net](https://demomusti-portal.quickcode.net)
- **Module APIs:**
    - link: [https://demomusti-identity-module.quickcode.net](https://demomusti-identity-module.quickcode.net)
    - etc.
...
```json
{
  "Routes": {
    "identity-module": {
      "Match": {
        "Hosts": ["demomusti-gateway.quickcode.net"],
  ...
  "Clusters": {
    "identity-module-api": {
      "Destinations": {
        "destination1": {
          "Address": "https://demomusti-identity-module.quickcode.net"
        }
      }
    }
  }
...
**Last generation Time**: [Generated on: 2026-02-20 09:52:54 UTC]