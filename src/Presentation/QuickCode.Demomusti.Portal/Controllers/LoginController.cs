...
using LoginRequest = QuickCode.Demomusti.Common.Nswag.Clients.IdentityModuleApi.Contracts.LoginRequest;


using ForgotPasswordRequest = QuickCode.Demomusti.Common.Nswag.Clients.IdentityModuleApi.Contracts.ForgotPasswordRequest;
using ResetPasswordRequest = QuickCode.Demomusti.Common.Nswag.Clients.IdentityModuleApi.Contracts.ResetPasswordRequest;
