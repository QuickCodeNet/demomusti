...
{
    public class SourceTypeData : BaseComboBoxModel
    {
        ...
        public SourceTypeDto SelectedItem { get; set; }
        public List<SourceTypeDto> List { get; set; }
    }

    public static partial class SourceTypeExtensions
    {
        public static string GetKey(this SourceTypeDto dto)
        {
            return $"{dto.Id}";
        }
    }
