...
using QuickCode.Demomusti.Common.Filters;
...
using QuickCode.Demomusti.Common.Mappers;
using Serilog;
...
using QuickCode.Demomusti.Common.ExceptionHandling;
...
builder.Services.AddOpenTelemetry()
    .ConfigureResource(resource => resource
        .AddService(serviceName: "QuickCode.Demomusti.CandidateTrackingModule.Api"))
