...
{
    public class ExperienceServiceDeleteTests : IDisposable
    {
        ...
        public ExperienceServiceDeleteTests()
        {
        ...
        public async Task DeleteItemAsync_Should_Return_Success_When_Item_Exists()
        {
            ...
            var fakeGetResponse = new RepoResponse<ExperienceDto>(fakeDto, "Success");
            var fakeDeleteResponse = new RepoResponse<bool>(true, "Success");
            _repositoryMock.Setup(r => r.GetByPkAsync(fakeDto.Id)).ReturnsAsync(fakeGetResponse);
            _repositoryMock.Setup(r => r.DeleteAsync(It.IsAny<ExperienceDto>())).ReturnsAsync(fakeDeleteResponse);
            // Act
            ...
            _repositoryMock.Verify(r => r.DeleteAsync(It.IsAny<ExperienceDto>()), Times.Once);
        }
        ...
        public async Task DeleteItemAsync_Should_Return_NotFound_When_Item_Does_Not_Exist()
        {
            var fakeDto = TestDataGenerator.CreateFake<ExperienceDto>("tr");
            // Arrange
            var fakeGetResponse = new RepoResponse<ExperienceDto>
            {
            ...
            _repositoryMock.Verify(r => r.GetByPkAsync(fakeDto.Id), Times.Once);
            _repositoryMock.Verify(r => r.DeleteAsync(It.IsAny<ExperienceDto>()), Times.Never);
        }
