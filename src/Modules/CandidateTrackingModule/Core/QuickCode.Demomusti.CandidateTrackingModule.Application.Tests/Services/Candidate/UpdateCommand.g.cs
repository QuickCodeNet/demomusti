...
{
    public class UpdateCandidateCommandTests : IDisposable
    {
        ...
        public UpdateCandidateCommandTests()
        {
        ...
        public async Task UpdateAsync_Should_Return_Success_When_Item_Exists()
        {
            ...
            _repositoryMock.Setup(r => r.UpdateAsync(It.IsAny<CandidateDto>())).ReturnsAsync(fakeUpdateResponse);
            // Act
            ...
            _repositoryMock.Verify(r => r.UpdateAsync(It.IsAny<CandidateDto>()), Times.Once);
        }
        ...
        public async Task UpdateAsync_Should_Return_NotFound_When_Item_Does_Not_Exist()
        {
            ...
            _repositoryMock.Verify(r => r.GetByPkAsync(fakeDto.Id), Times.Once);
            _repositoryMock.Verify(r => r.UpdateAsync(It.IsAny<CandidateDto>()), Times.Never);
        }
