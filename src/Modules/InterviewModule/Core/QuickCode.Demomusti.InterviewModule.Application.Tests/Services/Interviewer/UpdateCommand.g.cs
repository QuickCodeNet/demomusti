...
{
    public class UpdateInterviewerCommandTests : IDisposable
    {
        ...
        public UpdateInterviewerCommandTests()
        {
        ...
        public async Task UpdateAsync_Should_Return_Success_When_Item_Exists()
        {
            ...
            _repositoryMock.Setup(r => r.UpdateAsync(It.IsAny<InterviewerDto>())).ReturnsAsync(fakeUpdateResponse);
            // Act
            ...
            _repositoryMock.Verify(r => r.UpdateAsync(It.IsAny<InterviewerDto>()), Times.Once);
        }
        ...
        public async Task UpdateAsync_Should_Return_NotFound_When_Item_Does_Not_Exist()
        {
            ...
            _repositoryMock.Verify(r => r.GetByPkAsync(fakeDto.Id), Times.Once);
            _repositoryMock.Verify(r => r.UpdateAsync(It.IsAny<InterviewerDto>()), Times.Never);
        }
