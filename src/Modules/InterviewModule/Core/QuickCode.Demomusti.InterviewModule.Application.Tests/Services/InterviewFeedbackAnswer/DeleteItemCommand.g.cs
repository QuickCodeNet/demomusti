...
{
    public class InterviewFeedbackAnswerServiceDeleteTests : IDisposable
    {
        ...
        public InterviewFeedbackAnswerServiceDeleteTests()
        {
        ...
        public async Task DeleteItemAsync_Should_Return_Success_When_Item_Exists()
        {
            ...
            _repositoryMock.Setup(r => r.DeleteAsync(It.IsAny<InterviewFeedbackAnswerDto>())).ReturnsAsync(fakeDeleteResponse);
            // Act
            ...
            _repositoryMock.Verify(r => r.DeleteAsync(It.IsAny<InterviewFeedbackAnswerDto>()), Times.Once);
        }
        ...
        public async Task DeleteItemAsync_Should_Return_NotFound_When_Item_Does_Not_Exist()
        {
            ...
            _repositoryMock.Verify(r => r.GetByPkAsync(fakeDto.Id), Times.Once);
            _repositoryMock.Verify(r => r.DeleteAsync(It.IsAny<InterviewFeedbackAnswerDto>()), Times.Never);
        }
